% This script gives the scenario 3 and its error plot (first column of Fig.5) of our paper:
...
est_alpha =  linspace(0,pi,nr_bins)';
est_l1 = 1;
est_l2 = 2;
est = [repmat(est_m',nr_bins,1), est_alpha, repmat(est_l1',nr_bins,1), repmat(est_l2',nr_bins,1) ];
...
for i = 1:nr_bins
    ...
    subplot(1,2,2)
    hold on
    plot(est_alpha(i), d_kl(i),'b+', est_alpha(i), d_gw(i), 'r*',...
        est_alpha(i), d_uniform_OSPA4(i),'go', est_alpha(i),d_uniform_OSPA100(i),'k.')
